define(function(require,exports){
	...
	var _inputClass = config.inputClass,
		...
		_inputTipNums = config.inputTipNums;
	var patrns = require('../config.patrns')

	exports.showTipMessage = function(inputs){
		__action.__showTipMessage(inputs);
	};
	
	exports.ajaxErrorTip = function(index,tipHtml,tag){
		__action.__getTipMessage(index,tipHtml,tag);
	}
	
	exports.focusTipMessage = function(index,tipHtml,tag){
		__action.__focusTipMessage(index,tipHtml,tag);
	};
